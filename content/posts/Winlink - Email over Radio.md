...
2. Once you open Winlink Express, Click "Settings" then "Winlink Express Setup" in the Dropdown Menu
	1. ![Winlink_Setup.png](/attachments/Winlink%20-%20Email%20over%20Radio/Winlink_Setup.png)
3. This will open a new window:
	1. ![Winlink_Setup_Menu.png](/attachments/Winlink%20-%20Email%20over%20Radio/Winlink_Setup_Menu.png)
...
1. Back on the Home Page, Click the "Message" Button on the top row.
	1. ![Open_Message.png](/attachments/Winlink%20-%20Email%20over%20Radio/Open_Message.png)
2. This should open a window that looks like this:
	1. ![Message_Window.png](/attachments/Winlink%20-%20Email%20over%20Radio/Message_Window.png)
...
3. Now that we have a message in the outbox, let's send it over telnet! Click the Dropdown Menu next to "Open Session:" in the Top Right and select "Telnet Winlink"
	1. ![Session.png](/attachments/Winlink%20-%20Email%20over%20Radio/Session.png)
4. Now click "Open Session:"
	1. ![Open_Session.png](/attachments/Winlink%20-%20Email%20over%20Radio/Open_Session.png)
5. This will open a "Session Window". Anytime you send or receive Winlink messages it will be done through a Session Window, even when sending and receiving over radio.
	1. ![Pasted image 20251004215806.png](/attachments/Winlink%20-%20Email%20over%20Radio/Pasted%20image%2020251004215806.png)
6. Since this is just telnet, we don't need to alter any settings usually. Go ahead and click the "Start" button.
	1. ![Start_Session.png](/attachments/Winlink%20-%20Email%20over%20Radio/Start_Session.png)
7. Let the window do its thing until you see it disconnect. You should see something like this:
	1. ![Session_Actual.png](/attachments/Winlink%20-%20Email%20over%20Radio/Session_Actual.png)
...
# Winlink over Radio
***
![Pasted image 20251007114916.png](/attachments/Winlink%20-%20Email%20over%20Radio/Pasted%20image%2020251007114916.png)